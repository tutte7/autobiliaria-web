...
import { ALL_VEHICLES } from "@/lib/vehicles-data"
...
export default function OportunidadesPage() {
  ...
  const opportunityVehicles = useMemo(() => {
    return ALL_VEHICLES
      .filter((vehicle) => vehicle.opportunity)
      .map((vehicle) => ({
        id: vehicle.id,
        name: vehicle.name,
        price: vehicle.price,
        ...
        <div className="mx-auto max-w-[1100px] space-y-10">
          ...
          <div className="rounded-3xl border border-border bg-card px-6 py-8 text-center shadow-sm">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Explorá nuestro catálogo completo con más de {ALL_VEHICLES.length} vehículos disponibles.
            </p>
            <Link
              href="/comprar"
